...
FREObject AddProduct_32f( FREContext ctx, void* funcData, uint32_t argc, FREObject argv[] );
FREObject AddProductC_32f( FREContext ctx, void* funcData, uint32_t argc, FREObject argv[] );
