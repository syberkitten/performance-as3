package com.strix.lab.as3pp.matrix {
    ...
    public class ScalingMatrix3DArray extends Matrix3DArray {
        
        public function ScalingMatrix3DArray( length:uint=4 ) {
            super(length);
            reset();
        }
        ...
        public function setScaling( x:Float32Array, y:Float32Array, z:Float32Array ) : void {
            ArrayUtils.copy_32f(this.data[R1][C1], x);
            ArrayUtils.copy_32f(this.data[R2][C2], y);
            ArrayUtils.copy_32f(this.data[R3][C3], z);
        }
