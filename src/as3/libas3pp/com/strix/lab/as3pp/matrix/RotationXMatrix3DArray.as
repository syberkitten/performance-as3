package com.strix.lab.as3pp.matrix {
    ...
    public class RotationXMatrix3DArray extends Matrix3DArray {
        
        public function RotationXMatrix3DArray( length:uint=4 ) {
            this.data[R1][C1] = new Float32Array(length);
            this.data[R1][C4] = new Float32Array(length);
            this.data[R2][C2] = new Float32Array(length);
            this.data[R2][C3] = new Float32Array(length);
        ...
        public override function reset() : void {
            ...
            meta[R2][C3] = ValueElement;
            meta[R2][C4] = NullElement;
            
            meta[R3][C1] = NullElement;
            meta[R3][C2] = ValueElement;
        ...
        public function setRotationX( x:Float32Array ) : void {
            ArrayMath.cos_32f(this.data[R2][C2], x);
            ArrayUtils.copy_32f(this.data[R3][C3], this.data[R2][C2]);
            ArrayMath.sin_32f(this.data[R2][C3], x);
            ArrayMath.subcr_32f(this.data[R3][C2], this.data[R2][C3], 0);
        }
