package com.strix.lab.as3pp.matrix {
    ...
    public class TranslationMatrix3DArray extends Matrix3DArray {
        
        public function TranslationMatrix3DArray( length:uint=4 ) {
            super(length);
            reset();
        }
        ...
        public function setTranslation( x:Float32Array, y:Float32Array, z:Float32Array ) : void {
            ArrayUtils.copy_32f(this.data[R1][C4], x);
            ArrayUtils.copy_32f(this.data[R2][C4], y);
            ArrayUtils.copy_32f(this.data[R3][C4], z);
        }
